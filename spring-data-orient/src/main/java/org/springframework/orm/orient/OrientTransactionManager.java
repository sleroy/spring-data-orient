...
public class OrientTransactionManager extends AbstractPlatformTransactionManager implements ResourceTransactionManager {
	...
	private AbstractOrientDatabaseFactory<? extends ODatabase, ? extends ODatabasePoolBase>	dbf;
	...
	public OrientTransactionManager(
			final AbstractOrientDatabaseFactory<? extends ODatabase, ? extends ODatabasePoolBase> dbf) {
		super();
		this.dbf = dbf;
	}
	 ...
	 * @return the database
	 */
	public AbstractOrientDatabaseFactory<? extends ODatabase, ? extends ODatabasePoolBase> getDatabaseFactory() {
		return this.dbf;
	}
	...
	public void setDatabaseManager(
			final AbstractOrientDatabaseFactory<ODatabaseInternal<?>, ODatabasePoolBase<ODatabaseInternal<?>>> databaseFactory) {
